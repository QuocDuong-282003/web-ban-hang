    ...
    return (
        <div className="shoesnews">
            <div className="container">
                ...
                <div className="row">
                    {/* SỬA TOÀN BỘ PHẦN MAP Ở ĐÂY */}
                    {newsItems.map(newsItem => (
                        <div className="col-lg-4 col-md-4 col-sm-12 mb-20" key={newsItem._id}> {/* Sửa: key={newsItem._id} */}
                            {/* Sửa: Link to={`/news/${newsItem.slug}`} */}
                            <Link to={`/news-detail/${newsItem.slug}`} className="product__new-item">
                                <div className="card" style={{ width: '100%', height: '100%' }}>
                                    {/* Sửa: src={newsItem.imageBase64} */}
