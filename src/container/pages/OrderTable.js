...
// --- THAY THẾ TOÀN BỘ FILE: frontend/src/container/pages/templates/OrderTable.js ---
...
// Component StatusTag giữ nguyên logic của bạn
const StatusTag = ({ status }) => {
    const config = STATUS_TAG_CONFIG[status] || STATUS_TAG_CONFIG.default;
    return (
        <span style={{
