export const path = {
    ...
    // 📊 DASHBOARD
    DASHBOARD: '/system/dashboard', // Đã có, khớp với route "dashboard"

    SYSTEM_LOGIN_OUT: '/system/login-out',
    SYSTEM_FORGOT_LOGIN: '/system/forgot-password',
    SYSTEM_REGISTER: '/system/register',
    // 👤 USER MANAGEMENT & PROFILE
    ADMIN_PROFILE: '/system/profile', // Đã có, khớp với route "profile"
    ADMIN_USER_OVERVIEW: '/system/user', // Thêm mới để khớp với route "user"
    ...
    // 🛒 E-COMMERCE
    ADMIN_ECOMMERCE_OVERVIEW: '/system/ecommerce', // Thêm mới để khớp với route "ecommerce"
